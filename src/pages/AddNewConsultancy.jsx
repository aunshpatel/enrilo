    ...
    <div className="p-4">
      <div className="bg-white rounded-2xl shadow p-6 max-w-6xl mx-auto">
        ...
        <form className="grid grid-cols-1 md:grid-cols-3 gap-4" onSubmit={handleSubmit}>
          <TextField label="Consultancy Name" className="input" variant="outlined" />
          <TextField label="GST Number" className="input" variant="outlined" />
          <TextField label="Website" className="input" variant="outlined" />
          <TextField label="LinkedIn" className="input" variant="outlined" />
          <TextField label="Facebook" className="input" variant="outlined" />
          <TextField label="Instagram" className="input" variant="outlined" />
